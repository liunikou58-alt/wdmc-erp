...
router.get('/', auth, requirePermission('quotation_items', 'view'),(req, res) => {
...
router.get('/:id', auth, requirePermission('quotation_items', 'view'),(req, res) => {
  const item = db.getById('quotation_items', req.params.id);
  if (!item) return res.status(404).json({ error: '不存在' });
  res.json(item);
});

router.post('/', auth, requirePermission('quotation_items', 'create'),(req, res) => {
...
router.put('/:id', auth, requirePermission('quotation_items', 'edit'),(req, res) => {
  const updated = db.update('quotation_items', req.params.id, req.body);
  if (!updated) return res.status(404).json({ error: '不存在' });
  res.json(updated);
});

router.delete('/:id', auth, requirePermission('quotation_items', 'delete'),(req, res) => {
...
router.get('/categories/event', auth, requirePermission('quotation_items', 'view'),(req, res) => {
  res.json(db.getAll('event_categories').sort((a, b) => (a.sort_order || 0) - (b.sort_order || 0)));
});

router.post('/categories/event', auth, requirePermission('quotation_items', 'create'),(req, res) => {
...
router.put('/categories/event/:id', auth, requirePermission('quotation_items', 'edit'),(req, res) => {
  res.json(db.update('event_categories', req.params.id, req.body));
});

router.delete('/categories/event/:id', auth, requirePermission('quotation_items', 'delete'),(req, res) => {
...
router.get('/categories/po', auth, requirePermission('quotation_items', 'view'),(req, res) => {
  res.json(db.getAll('po_categories').sort((a, b) => (a.sort_order || 0) - (b.sort_order || 0)));
});

router.post('/categories/po', auth, requirePermission('quotation_items', 'create'),(req, res) => {
...
router.delete('/categories/po/:id', auth, requirePermission('quotation_items', 'delete'),(req, res) => {
