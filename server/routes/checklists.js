...
router.get('/', auth, requirePermission('checklists', 'view'),(req, res) => {
...
router.get('/:id', auth, requirePermission('checklists', 'view'),(req, res) => {
...
router.post('/', auth, requirePermission('checklists', 'create'),(req, res) => {
...
router.post('/:id/items', auth, requirePermission('checklists', 'create'),(req, res) => {
...
router.put('/items/:itemId/toggle', auth, requirePermission('checklists', 'edit'),(req, res) => {
...
router.put('/items/:itemId', auth, requirePermission('checklists', 'edit'),(req, res) => {
  const updated = db.update('checklist_items', req.params.itemId, req.body);
  res.json(updated);
});

// DELETE /api/checklists/:id
router.delete('/:id', auth, requirePermission('checklists', 'delete'),(req, res) => {
...
// === 預設範本 ===
router.get('/templates/list', auth, requirePermission('checklists', 'view'),(req, res) => {
  res.json([
