  ...
  return (
    <>
      <div className="page-header">
        <div><h1 className="page-title">👷 人力調度</h1><p className="page-subtitle">排班管理、衝突檢查、人員可用性</p></div>
        <button className="btn btn-primary" onClick={() => setShowAdd(true)}>➕ 新增排班</button>
      </div>
      ...
      {showAdd && (
        <div className="card" style={{ marginBottom: 16 }}>
          <h3 style={{ fontSize: 15, fontWeight: 700, marginBottom: 12 }}>新增排班</h3>
      ...
      <div className="card">
        ...
        {schedules.length === 0 ? <p style={{ color: 'var(--c-text-muted)', textAlign: 'center', padding: 20 }}>尚無排班</p> : (
          <div className="table-wrap"><table>
            <thead><tr><th>人員</th><th>部門</th><th>專案</th><th>日期</th><th>班次</th><th>地點</th><th>操作</th></tr></thead>
